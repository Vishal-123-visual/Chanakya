...
const createdAt = moment(filterOne.amountDate)
if (fromDate && toDate) {
...
[].filter((filterOne) => {
const createdAt = moment(filterOne.dayBookDatadate)
if (fromDate && toDate) {
const startDate = moment(fromDate).startOf('day')
const endDate = moment(toDate).endOf('day')
return createdAt.isBetween(startDate, endDate, null, '[]')
...
[]
//console.log(filteredDayBookData)
...
{/_ begin::Table container _/}
<div className='table-responsive'>
{/_ begin::Table _/}
<table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
{/_ begin::Table head _/}
<thead>
...
{/_ end::Table head _/}
{/_ begin::Table body _/}
<tbody>
<AddDayBookData
                totalAmount={totalFeesAmount}
                setTotalFeesAmount={setTotalFeesAmount}
              />
