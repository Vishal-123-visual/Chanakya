...
export const addEmailTemplateController = asyncHandler(async(req,res,next) => {
    try {
        ...
        if (!customTemplate) {
          ...
          emailsTemplates.forEach(async (emailsTemplates) => await emailsTemplates.deleteOne());
...
export const getEmailTemplateController = asyncHandler(
    async (req, res) => {
      try {
