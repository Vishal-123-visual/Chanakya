...
const Dynamic = ({companyName, formId}) => {
  ...
  // console.log(singleCompanyId)

  // const companyId = getAllAddedFormsName?.data
  //   ?.filter((comapnyById) => comapnyById.companyName === singleCompanyId)
  //   .map((company) => company.companyName)
  // console.log('company name', companyId)

  // const formNameById = getAllAddedFormsName?.data
  //   ?.filter((company) => company?.companyName === singleCompanyId)
  //   .map((form) => form?.formName)

  // console.log(formNameById)

  // const formList = getAllAddedFormsName?.data?.filter(
  //   (form) => form.companyName === singleCompanyId
  // )
  ...
  // console.log('fields data', formId)
