...
const BatchForm = () => {
    ...
    const { getAllLabsData, getAllTrainersData } = useAttendanceContext()
                                    ...
                                    <div className='fv-row mt-5 '>
                                        ...
                                        >
                                            ...
                                            {getAllTrainersData?.data?.map((trainer) =>
                                                <option key={trainer?._id} value={trainer?.trainerName}>{trainer?.trainerName}</option>
                                            )}
                                        </select>
                                    </div>
                                </label>
                                ...
                                <label className='col-6 col-form-label required fw-bold fs-6'>
                                    ...
                                    <div className='fv-row mt-5 '>
                                        ...
                                        >
                                            ...
                                            {getAllLabsData?.data?.filter((company) => company.companyId === params?.id).map((lab) =>
