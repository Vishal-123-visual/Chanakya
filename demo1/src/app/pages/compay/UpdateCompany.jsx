...
const UpdateCompany = () => {
  ...
  const [updatedCompanyData, setUpdateCompanyData] = useState(location.state)
  ...
  useEffect(() => {
    setPreview(`${BASE_URL_Image}/${updatedCompanyData?.logo}`)
  }, [])
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      companyCTX.updateCompanyMutation.mutate(formData)
      navigate('/company')
    },
  })
  return (
      ...
      <div className='card mb-5 mb-xl-10'>
        ...
        >
          <div className='card-title m-0'>
            <h3 className='fw-bolder m-0'>Update Company</h3>
          </div>
        </div>
          ...
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            <div className='card-body border-top p-9'>
              <div className='d-flex align-items-center  justify-content-between '>
                <img src={preview} alt='' width={100} className='img-thumbnail flex-1' />
